...
public class NewCreatePVPConversationUseCase extends UseCase<Conversation, NewCreatePVPConversationUseCase.Params> {
    @Inject
    ...
    @Inject
    public NewCreatePVPConversationUseCase(@NotNull ThreadExecutor threadExecutor, @NotNull PostExecutionThread postExecutionThread) {
    ...
    public Observable<Conversation> buildUseCaseObservable(Params params){
        return userManager.getUserInfoByUserUUidKey(params.toUser.key)
                .flatMap(toUserInfo ->
         userManager.getCurrentUser()
                .flatMap(user -> {
                    List<User> members = new ArrayList<>();
                    params.toUser = toUserInfo;
