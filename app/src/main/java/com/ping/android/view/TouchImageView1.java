...
public class TouchImageView1 extends android.support.v7.widget.AppCompatImageView {
    ...
    private void sharedConstructing(Context context) {
        ...
        mScaleDetector = new ScaleGestureDetector(context, new TouchImageView1.ScaleListener());
