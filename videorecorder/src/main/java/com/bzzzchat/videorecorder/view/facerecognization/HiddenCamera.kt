                ...
                .addOnSuccessListener { faces ->
                    if (faces.size > 0) {
                        ...
                        try {
                            ...
                            out = FileOutputStream(File(Environment.getExternalStorageDirectory(), fileName))
                        ...
                        processFaceRecognition(Environment.getExternalStorageDirectory().absolutePath + "/user.png")
                    }
